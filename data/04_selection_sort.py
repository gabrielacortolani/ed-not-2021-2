...
def selection_sort(lista):
    """
       Função que implementa o algortimo de ordenação selection sort
    """
    ...
    for pos_sel in range(len(lista)-1):
        ...
        for j in range(pos_sel + 2, len(lista)):
            ...
            # que o elemento da posição do menor (pos_menor),
...
# Valores das variávei no início do selection sort:
...
nomes_parcial = nomes[:100000] # Usa apenas ps primeiros 30 mil nomes.
