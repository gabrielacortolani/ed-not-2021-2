"""
    ...
    3) O ponteiro para a subárvore esquerda (right)
"""  
class Node: 
...
class BinarySearchTree:
    ...
    """
        Método _-privado para inserção de um nodo na árvore
    """
    def __insert_node(self, node, root):
        ...
        # 2º caso: valor do nodo é MAIOR que o valor da rais ~> vai para a DIREITA
