...
class BinarySearchTree:
    ...
    """       
        ...
        1º: visita em-ordem a cubárvore esquerda
        2º: visita a raiz
    ...
    """       
        Método que faz o percurso pré-ordem (pré-order traversal)
        1º: visita a raiz
...
print('Percuso em-ordem:', em_ordem)
...
print('Sumario pré-ordem:', pre_ordem)