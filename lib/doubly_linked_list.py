...
class DoublyLinkedList:
    ...
    """
        Método que encontra a posição de um nodo, dados o seu valor
    """
    def index(self, val):
    ...
    def insert(self, pos, val):
        ...
        # 2º caso: inserção na posição inicial
            ...
            inserted.next = self.__head  # Apontar para o seguinte
    ...
    def remove(self, pos):
        ...
        if pos == 0:
            ...
            # Em caso de remoção do único nodo restante, __ head é None,
            # e __ tail precisa ser None também
