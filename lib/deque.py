class Deque:
    ...
    """  
        ...
        - Deque é uma lista linear de acesso restrito, que permite apenas 
        as operações  de enfileiramento (insert_front/insert_back) e desenfileiramento  
    ...
    """
       Método para verificar se o deque está vazia ou não
