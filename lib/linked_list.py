"""
    ...
    1) Onde fica armezanada a informação relevante para o usuário (__data)
...
class LinkedList:
    ...
    def insert(self, pos, val):
        ...
        # Vamos considerar qualquer posição de inserção >=
        ...
        # Percorre a lita encadeada até a pisição ANTERIOR
        # aquela de inserção
