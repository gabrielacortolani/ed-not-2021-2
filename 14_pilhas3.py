"""
   ANALISADOR DE EXPRESSÔES MATEMÀTICAS
"""
...
def verif_fechamento(tipo_fecha, pos_fecha, dados_abre):
    # Se o tipo que veio da pilha dor igual ao tipo encontrado
    # no fechamento, OK
...
while not analisador.is_empty():
    ...
    print(f"ERRO: símbolo de abertura {sobra['tipo']} sem símbolo de fechamentocorrespondente na posição {sobra['pos']}")